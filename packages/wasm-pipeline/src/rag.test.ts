...
describe("rag.ts orchestration (SearchStore wiring)", () => {
  it("buildIndex -> retrieve returns the ingested chunk via hybrid search", async () => {
    const items: IndexedChunk[] = [
      { docId: "m1", chunkIndex: 0, text: "Acme Corp signed clause 9", citation: "m1#c0", vector: fill(768, 0.1) },
      { docId: "m1", chunkIndex: 1, text: "unrelated cooking recipe", citation: "m1#c1", vector: fill(768, -0.1) },
    ];
