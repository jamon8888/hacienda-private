...
export function embedChunks(chunks: EmbeddableChunk[], onProgress?: (progress: FetchProgress) => void): Promise<Float32Array[]> {
...
export function ensureEmbedSession(_scenario: ModelScenario, onProgress?: (progress: FetchProgress) => void): Promise<void> {
...
export { ensureGraniteEmbedder, graniteEmbeddingDimension, graniteEmbeddingIdentity, resetGraniteEmbedder } from "./granite-embed";
