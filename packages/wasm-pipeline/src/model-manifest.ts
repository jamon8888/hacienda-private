import { API_BASE, GRANITE_EMBEDDING_FALLBACK_FILES, GRANITE_EMBEDDING_FALLBACK_SHA256, GRANITE_EMBEDDING_MANIFEST_NAMES, MODEL_MANIFEST_URL } from "./constants";
...
export async function resolveGraniteArtifacts(): Promise<GraniteArtifactSet> {
	...
	return {
		...
		tokenizer: { url: manifestFileUrl(tokenizer.file), sha256: tokenizer.sha256 },
