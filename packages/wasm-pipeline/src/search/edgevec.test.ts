...
describe("EdgeVecSearchStore", () => {
  ...
  it("persist -> load round-trips a fresh store instance to the same query results", async () => {
    ...
    await writer.ingest([
      { docId: "m4", chunkIndex: 0, text: "Acme Corp signed clause 9", citation: "m4#c0", vector: fill(768, 0.1) },
      { docId: "m4", chunkIndex: 1, text: "unrelated cooking recipe", citation: "m4#c1", vector: fill(768, -0.1) },
    ]);
