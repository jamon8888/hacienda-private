  ...
  return (
    <Popover open={isExpanded} onOpenChange={onExpandedChange}>
      ...
      >
        ...
        {value ? <span className="absolute top-1 right-1 size-1.5 rounded-full bg-primary" /> : null}
      </PopoverTrigger>
  ...
  return (
    <DropdownMenu>
      ...
      >
        ...
        {filters.length > 0 ? <span className="absolute top-1 right-1 size-1.5 rounded-full bg-primary" /> : null}
      </DropdownMenuTrigger>
  ...
  return (
    <div className="flex items-center text-xs">
      ...
      <button
        ...
        onClick={onRemove}
        className={cn(FILTER_PILL_BUTTON_CLASSNAME, "rounded-r-md px-1 text-muted-foreground hover:text-foreground")}
      >
        <HugeiconsIcon icon={Cancel01Icon} className="size-3" />
      </button>
    </div>
