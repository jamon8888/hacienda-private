...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.GroupLabel
      className={cn("px-2 py-1.5 text-xs font-medium text-muted-foreground data-[inset=true]:ps-8", className)}
      data-inset={inset}
...
function DropdownMenuShortcut({ className, ...props }: React.ComponentProps<"span">): React.ReactElement {
  return (
    <span
      className={cn("ms-auto text-xs font-medium text-muted-foreground", className)}
